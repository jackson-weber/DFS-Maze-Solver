...
memory: $(EXEC)
	$(VALGRIND) --log-file=log1 ./$(EXEC) inputs/maze1
	$(VALGRIND) --log-file=log2 ./$(EXEC) inputs/maze2
	$(VALGRIND) --log-file=log3 ./$(EXEC) inputs/maze3
	$(VALGRIND) --log-file=log4 ./$(EXEC) inputs/maze4
	$(VALGRIND) --log-file=log5 ./$(EXEC) inputs/maze5
